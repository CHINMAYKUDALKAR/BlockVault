...
export const FileUpload: React.FC<FileUploadProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <Card 
        className="relative w-full max-w-2xl bg-card border-border shadow-2xl"
      ...
      >
        <div className="p-8">
          ...
          {errorMessage && uploadStatus !== 'uploading' && (
            <div className="mb-4 p-3 rounded-lg bg-destructive/10 border border-destructive/50 flex items-center gap-2">
          ...
          {uploadStatus === 'success' && (
            <div className="mb-4 p-3 rounded-lg bg-success/10 border border-success/50 flex items-center gap-2">
