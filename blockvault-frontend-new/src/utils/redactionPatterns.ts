...
export function findAllRedactions(
  ...
  console.log('🔍 findAllRedactions called:');
  console.log('   Text length:', text.length);
  console.log('   Enabled patterns:', enabledPatterns);
  ...
  enabledPatterns.forEach(patternId => {
    console.log(`   Checking pattern: ${patternId}`);
    ...
    if (pattern) {
      console.log(`      Found pattern definition: ${pattern.name}`);
      ...
      console.warn(`      ⚠️ No pattern found for ID: ${patternId}`);
      console.log(`      Available patterns:`, Object.keys(REDACTION_PATTERNS));
    }
  });
